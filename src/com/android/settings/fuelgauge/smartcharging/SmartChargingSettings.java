...
public class SmartChargingSettings extends DashboardFragment implements OnPreferenceChangeListener {
    ...
    private SeekBarPreference mSmartChargingLevel;
    private SeekBarPreference mSmartChargingResumeLevel;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mSmartChargingLevel = (SeekBarPreference) findPreference(KEY_SMART_CHARGING_LEVEL);
        int currentLevel = org.eu.droid_ng.providers.NgSettings.Global.getInt(getContentResolver(),
            org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_LEVEL, mSmartChargingLevelDefaultConfig);
        mSmartChargingLevel.setValue(currentLevel);
        mSmartChargingLevel.setOnPreferenceChangeListener(this);
        mSmartChargingResumeLevel = (SeekBarPreference) findPreference(KEY_SMART_CHARGING_RESUME_LEVEL);
        int currentResumeLevel = org.eu.droid_ng.providers.NgSettings.Global.getInt(getContentResolver(),
            org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_RESUME_LEVEL, mSmartChargingResumeLevelDefaultConfig);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mSmartChargingLevel) {
            ...
            int mChargingResumeLevel = org.eu.droid_ng.providers.NgSettings.Global.getInt(getContentResolver(),
                    org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_RESUME_LEVEL, mSmartChargingResumeLevelDefaultConfig);
            org.eu.droid_ng.providers.NgSettings.Global.putInt(getContentResolver(),
                    org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_LEVEL, smartChargingLevel);
            ...
            if (smartChargingLevel <= mChargingResumeLevel) {
                ...
                org.eu.droid_ng.providers.NgSettings.Global.putInt(getContentResolver(),
                    org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_RESUME_LEVEL, smartChargingLevel - 1);
            }
            return true;
        } else if (preference == mSmartChargingResumeLevel) {
            int smartChargingResumeLevel = (Integer) objValue;
            int mChargingLevel = org.eu.droid_ng.providers.NgSettings.Global.getInt(getContentResolver(),
                    org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_LEVEL, mSmartChargingLevelDefaultConfig);
                mSmartChargingResumeLevel.setMax(mChargingLevel - 1);
                org.eu.droid_ng.providers.NgSettings.Global.putInt(getContentResolver(),
                    org.eu.droid_ng.providers.NgSettings.Global.SMART_CHARGING_RESUME_LEVEL, smartChargingResumeLevel);
            return true;
        } else {
            return false;
        }
